...
export default function CTA() {
  return (
    <section className="py-20 bg-gradient-to-r from-primary via-accent to-accent/50 relative overflow-hidden">
      {/* Animated Background */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-white/90 mb-8">
            Join hundreds of students who are already building their future with IT-SPARK
          </p>
